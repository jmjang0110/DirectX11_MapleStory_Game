...
public:
    CStructuredBuffer* GetParticleBuffer() { return m_ParticleBuffer; }
    CStructuredBuffer* GetParticleDataBuffer() { return m_ParticleDataBuffer; }

public:
    CDamageParticleShader();
    ~CDamageParticleShader();
};
