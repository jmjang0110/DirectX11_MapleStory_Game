...
DamageParticleUI::DamageParticleUI()
	: ComponentUI("DamageParticleSystem", COMPONENT_TYPE::DAMAGE_PARTICLESYSTEM)
...
void DamageParticleUI::render_update()
{
	ComponentUI::render_update();

	CDamageParticle* pParticleSystem = GetTargetObject()->DamageParticle();
